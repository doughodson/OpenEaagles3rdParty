...
#if !defined(_CIGI_SHORT_COMP_CTRL_V3_3_INCLUDED_)
#define _CIGI_SHORT_COMP_CTRL_V3_3_INCLUDED_

#include "CigiBaseCompCtrl.h"



class CIGI_SPEC CigiShortCompCtrlV3_3 : public CigiBaseCompCtrl
{
...
#endif // #if !defined(_CIGI_SHORT_COMP_CTRL_V3_3_INCLUDED_)
